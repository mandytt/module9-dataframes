#Factors can't do the same functions as vectors
#no adding/operations
...
farmrizzle <- data.frame(USPersonalExpenditure)
...
farmrizzle$category <- rownames(farmrizzle)

# How much money was spent on personal care in 1940?
farmrizzle <- ("Personal Care, X1940")

# How much money was spent on Food and Tobacco in 1960?
farmrizzle <- ("Food and Tobacco, X1960")
